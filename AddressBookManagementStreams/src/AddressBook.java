...
import java.util.stream.Collectors;
	...
	// Created search contact method to find if any contact with the same first name 
			 ...
			 public void searchPerson() {
			        ...
			        personInfo.stream().filter(personInfo -> personInfo.getFirstName().equals(firstName)).
			        					forEach(personInfo -> System.out.println(personInfo));
			        }
			 }
			 
	// Created method to search a person by city or state, instead of showing mobile number displaying contact information.
			 ...
			 public void searchByCityOrState() {
			        ...
			        personInfo.stream().filter(personInfo -> personInfo.getCity().equals(city)).
	...
	//Stream API method to count person in the same city.
			 
			 public void countByCity(){
					
		         System.out.println(
		        		 personInfo.stream().collect(Collectors.groupingBy((Person person) -> person.getCity()))
		        		 );
		         System.out.println(
		        		 personInfo.stream().collect(Collectors.groupingBy((Person person) -> person.getCity(),
		                      Collectors.counting()))
	...
	// Stream API method to count person in the same state.
			 
			public void countByState() {
				
		      System.out.println(
		    		  personInfo.stream().collect(Collectors.groupingBy((Person person) -> person.getState()))
		    		  );
		      System.out.println(
		    		  personInfo.stream().collect(Collectors.groupingBy((Person person) -> person.getState(),
		              Collectors.counting()))
	...
	//Created Stream API to sort contact alphabetically.
			...
			public void sortContactListByFirstName() {
			        ...
			        personInfo.forEach((Person person) -> System.out.println(person.getFirstName() + " " + person.getLastName()));
			    }
	// Sorting contact details by PinCode and hence displaying results by calling to string method.
		    ...
		    public void sortContactListByZip() {
			        ...
			        personInfo.sort(Comparator.comparing(Person::getPincode));
			        
			        personInfo.forEach((Person person) -> System.out.println(person.toString()));
			    }
